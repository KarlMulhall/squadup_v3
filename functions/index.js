...
exports.onFollowUser = functions.firestore.document(
    ...
    // Add followed user's posts to the user's post home screen
...
exports.onUnfollowUser = functions.firestore
  ...
  .onDelete(async (_, context) => {
    ...
    // Remove unfollowed user's posts from user's post home screen
    const userFeedRef = admin
      .firestore()
      .collection('feeds')
      .doc(followerId)
...
exports.onCreatePost = functions.firestore
  ...
  .onCreate(async (snapshot, context) => {
    ...
    //add new post to home screens of all followers
