...
class ProfileLoadPlayer extends ProfileEvent {
  final String playerId;

  const ProfileLoadPlayer({@required this.playerId});
...
class ProfileUpdatePlayers extends ProfileEvent {
  final List<Player> players;

  const ProfileUpdatePlayers({@required this.players});
